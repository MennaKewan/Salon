...
//     fetch(`https://the-real-project-backend-production-de46.up.railway.app/users/login`, {
//       method: 'POST',
//       headers: {
...
//           onLogin(data.token, userRole);  // Set the token and role in the parent component
//         } else {
...
//       <div className="content">
//         <h1 className="title1">تسجيل الدخول</h1>
//         <form onSubmit={handleSubmit}  > {/* Apply RTL direction to the form */}
//           <div className="form-group">
...
//           <button type="submit" onClick={handleSubmit}>تسجيل الدخول</button>
//         </form>
//       </div>
//     </div>
//   );
